...
if (!function_exists('time_ago')) {
    function time_ago($timestamp) {
        ...
        // ⭐️ CORREÇÃO ESSENCIAL: Pega o valor absoluto para garantir que a diferença
        // seja sempre positiva, resolvendo o erro de "-12 dias atrás".
        ...
        // Ajustamos o retorno para ser consistente e garantir que "atrás" seja sempre usado
        elseif ($minutes <= 60) return $minutes == 1 ? "há 1 minuto atrás" : "há {$minutes} minutos atrás";
        elseif ($hours <= 24) return $hours == 1 ? "há 1 hora atrás" : "há {$hours} horas atrás";
        elseif ($days <= 7) return $days == 1 ? "há 1 dia atrás" : "há {$days} dias atrás";
        elseif ($weeks <= 4.3) return $weeks == 1 ? "há 1 semana atrás" : "há {$weeks} semanas atrás";
        elseif ($months <= 12) return $months == 1 ? "há 1 mês atrás" : "há {$months} meses atrás";
        else return $years == 1 ? "há 1 ano atrás" : "há {$years} anos atrás";
    }
}
// ------------------------------------------------------------------------------------------------
